...
export default function Receipt({ price }: { price: number }) {

    function totalPrice(price: number) {
        let total: number = price + (price * 10 / 100) + 5
        return total
    }
    let total: number = totalPrice(price);
        ...
        <div className='bg-slate-50 p-8 mt-2 rounded-lg'>
            ...
            <div className='lf'>
                ...
                <div className='text-sm pt-4 mt-4 flex justify-between text-base text-gray-900 border-t border-gray-200'>
                    ...
                    <span className='font-medium'>${price * (10 / 100)}</span>
                </div>
                <div className='text-sm pt-4 mt-4 flex justify-between text-base text-gray-900 border-t border-gray-200'>
