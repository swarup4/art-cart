...
*/
router.post('/addGallery', userMiddleware.varifyToken, (req, res) => {
    let obj = req.body;
    ...
    model.save((err, data) => {
        if (err) {
            ...
            res.json({
                success: true,
                message: 'Gallery Add into database'
            });
        }
    });
});

router.put('/updateGallery/:id', userMiddleware.varifyToken, (req, res) => {
...
router.delete('/deleteGallery/:id', userMiddleware.varifyToken, (req, res) => {
    const id = req.params.id;
...
*/
router.post('/addGalleryDetails', userMiddleware.varifyToken, (req, res) => {
...
router.put('/updateGalleryDetails/:id', userMiddleware.varifyToken, (req, res) => {
    const id = req.params.id;
    const body = req.body;
